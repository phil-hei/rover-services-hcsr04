...
RoverHcsr04Demo::RoverHcsr04Demo(RoverHcsr04UltrasonicSensor *hcsr04_sensor, RoverDisplay * disp, RoverButtons * btn) {
...
bool RoverHcsr04Demo::check_button() {
  double state = 1;
