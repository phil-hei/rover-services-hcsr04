...
#include <service/ServiceRoverHmc5883L.h>
// #include <all_types.h>

static ServiceRoverHmc5883L obj;
...
static void set_address(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling set_address");


  if (args) {
    // Parse args if possible
    if (!json_object_object_get_ex(args, "address", &val[0])) {
      AFB_ERROR("[roverhmc5883l] No 'address' param provided");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'set_address' returning error");
...
static void set_declination_angle(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling set_declination_angle");


  if (args) {
    // Parse args if possible
    if (!json_object_object_get_ex(args, "angle", &val[0])) {
      AFB_ERROR("[roverhmc5883l] No 'angle' param provided");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'set_declination_angle' returning error");
...
static void get_address(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling get_address");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'get_address' returning error");
...
static void read(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling read");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'read' returning error");
...
static void get_declination_angle(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling get_declination_angle");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'get_declination_angle' returning error");
...
static void calibrate(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling calibrate");
  ...
  ret = obj.calibrate();
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'calibrate' returning error");
...
static void get_calibration_period(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling get_calibration_period");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'get_calibration_period' returning error");
...
static void set_calibration_period(struct afb_req request) {
  ...
  AFB_NOTICE("[roverhmc5883l] Calling set_calibration_period");


  if (args) {
    // Parse args if possible
    if (!json_object_object_get_ex(args, "period", &val[0])) {
      AFB_ERROR("[roverhmc5883l] No 'period' param provided");
  ...
  if (ret) {
    AFB_ERROR("[roverhmc5883l] Verb 'set_calibration_period' returning error");
...
static const struct afb_verb_v2 verbs[] = {
  /*Without security*/
  {.verb = "set_address", .callback = set_address, .auth = NULL, .info = "Sets the HMC5883L Address", .session = 0},
  {.verb = "set_declination_angle", .callback = set_declination_angle, .auth = NULL, .info = "Set the declination angle", .session = 0},
  {.verb = "get_address", .callback = get_address, .auth = NULL, .info = "Get the HMC5883L Address", .session = 0},
  {.verb = "read", .callback = read, .auth = NULL, .info = "Read the bearing value from Bearing sensor Sunfounder HMC5883L", .session = 0},
...
const struct afb_binding_v2 afbBindingV2 = {
  .api = "roverhmc5883l",
  .specification = "",
  .info = "Auto generated - Rover Hmc5883L",
  .verbs = verbs,
  .preinit = NULL,
  .init = init,
  .onevent = NULL,
