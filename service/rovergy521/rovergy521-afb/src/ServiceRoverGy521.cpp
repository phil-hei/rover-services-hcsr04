...
int ServiceRoverGy521::read_acc_x(int &out_acc_x) {
  ...
  AFB_ERROR("Method Read_acc_x not implemented");
...
int ServiceRoverGy521::read_acc_y(int &out_acc_y) {
  ...
  AFB_ERROR("Method Read_acc_y not implemented");
...
int ServiceRoverGy521::read_acc_z(int &out_acc_z) {
  ...
  AFB_ERROR("Method Read_acc_z not implemented");

  return -1;
}

/** Autogenrated doc for read_angle_x */
int ServiceRoverGy521::read_angle_x(double &out_acc_x) {

  AFB_NOTICE("[ServiceRoverGy521] Read_angle_x");
  AFB_ERROR("Method Read_angle_x not implemented");

  return -1;
}

/** Autogenrated doc for read_angle_y */
int ServiceRoverGy521::read_angle_y(double &out_acc_y) {

  AFB_NOTICE("[ServiceRoverGy521] Read_angle_y");
  AFB_ERROR("Method Read_angle_y not implemented");

  return -1;
}

/** Autogenrated doc for read_angle_z */
int ServiceRoverGy521::read_angle_z(double &out_acc_z) {

  AFB_NOTICE("[ServiceRoverGy521] Read_angle_z");
  AFB_ERROR("Method Read_angle_z not implemented");
...
int ServiceRoverGy521::read_gyro_x(int &out_gyro_x) {
  ...
  AFB_ERROR("Method Read_gyro_x not implemented");
...
int ServiceRoverGy521::read_gyro_y(int &out_gyro_y) {
  ...
  AFB_ERROR("Method Read_gyro_y not implemented");
...
int ServiceRoverGy521::read_gyro_z(int &out_gyro_z) {
  ...
  AFB_ERROR("Method Read_gyro_z not implemented");
